...
export default function ClientLogos() {
  return (
    <section className="py-14 relative bg-white overflow-hidden">
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {[...clients, ...clients].map((client, i) => (
              <div
                key={i}
                className="flex items-center gap-3 px-6 py-3 rounded-xl bg-slate-50 border border-slate-200 shadow-sm flex-shrink-0 min-w-[160px]"
              >
                ...
                <span className="text-sm text-slate-600 whitespace-nowrap">{client.name}</span>
              </div>
            ))}
          </motion.div>
        </div>
